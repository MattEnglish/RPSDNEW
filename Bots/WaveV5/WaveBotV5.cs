...
namespace Bots.WaveV5
{
    ...
    public class WaveBotV5 : IBot
    {
        public string Name => "WaveV5";
        ...
        private double calculateProb(double pBase, double pWave, double scaler)
        {
            var x = (1 - scaler) * pBase + scaler * pWave;
            if(x < 0)
            {
                throw new Exception();
            }
